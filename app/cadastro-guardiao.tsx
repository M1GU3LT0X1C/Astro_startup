...
export default function CadastroGuardiao() {
  ...
  function avancar() {
    ...
    Toast.show({
      type: 'success',
      text1: 'Guardião registrado!',
      text2: 'Vamos configurar seu perfil 🛡️',
      visibilityTime: 2000,
    });
    ...
    setTimeout(() => {
      router.push({
        ...
        params: { 
          ...
          numero, 
          cpf: cpf.replace(/\D/g, ''), 
          tipo_usuario: 'guardiao' // ← ÚNICA DIFERENÇA
        }
      });
    }, 1000);
  }
  ...
  return (
    ...
    >
      ...
      <Text style={styles.description}>
        Guardiões protegem e guiam exploradores. Sincronize seus dados para assumir sua posição no setor e conectar-se com sua tripulação.
      </Text>
